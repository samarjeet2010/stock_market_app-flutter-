...
/// Financial-themed color palette for light mode
class LightModeColors {
  // Primary: Deep Blue for trust and stability
  static const lightPrimary = Color(0xFF1E3A5F);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE8EEF5);
  static const lightOnPrimaryContainer = Color(0xFF0A1929);

  // Secondary: Emerald Green for growth and profit
  static const lightSecondary = Color(0xFF10B981);
  static const lightOnSecondary = Color(0xFFFFFFFF);

  // Tertiary: Slate for neutral elements
  static const lightTertiary = Color(0xFF64748B);
  static const lightOnTertiary = Color(0xFFFFFFFF);

  // Error colors: Crimson Red for loss and warnings
...
/// Financial-themed dark mode colors
class DarkModeColors {
  // Primary: Lighter blue for dark background
  static const darkPrimary = Color(0xFF60A5FA);
  static const darkOnPrimary = Color(0xFF0A1929);
  static const darkPrimaryContainer = Color(0xFF1E3A5F);
  static const darkOnPrimaryContainer = Color(0xFFE8EEF5);

  // Secondary: Bright Green for profit
  ...
  static const darkOnTertiary = Color(0xFF1E293B);

  // Error colors: Bright Red for loss
  ...
  static const darkInversePrimary = Color(0xFF1E3A5F);

  // Custom colors for financial app
  static const profitGreen = Color(0xFF34D399);
  static const lossRed = Color(0xFFF87171);
}
